...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(calendarView:loadPhoto:forDate:)]) {
        [self.delegate calendarView:self loadPhoto:cell.uiPhoto forDate:date];
    }
...
- (CGSize)  collectionView:(UICollectionView *)collectionView
	...
	CGFloat itemHeight = indexPath.item < self.daysInWeek ? 30.f : itemWidth + 20.0f;
